...
class CNavView : 
	public CWindowImpl< CNavView >,
	public Frames::Host
{
public:
	DECLARE_WND_CLASS(NULL)

	CJumpingGirlPath m_path;
	...
	CNavView() : m_brush(Gdiplus::Color(NavForeGround))
	{
		//m_layout.m_navigation.Add(new Frames::Heading(L"ergo active"));
	...
	{	
		...
		// Draw the jumping lady		
		Gdiplus::Rect rectPath(m_path.m_rectPath);
		...
		graphics.FillPath(&m_brush, &m_path.m_path);
