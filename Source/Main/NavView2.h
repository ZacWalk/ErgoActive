// ErgoActiveView.h : interface of the CNavView class
//
/////////////////////////////////////////////////////////////////////////////
...
namespace IW
{
	...
	namespace svg
	{
		...
		public:
			...
			void move_to(Gdiplus::REAL x, Gdiplus::REAL y, bool rel=false);   // M, m
			void line_to(Gdiplus::REAL x,  Gdiplus::REAL y, bool rel=false);  // L, l
			void hline_to(Gdiplus::REAL x, bool rel=false);            // H, h
			void vline_to(Gdiplus::REAL y, bool rel=false);            // V, v
			void curve3(Gdiplus::REAL x1, Gdiplus::REAL y1,                   // Q, q
				Gdiplus::REAL x,  Gdiplus::REAL y, bool rel=false);
			void curve3(Gdiplus::REAL x, Gdiplus::REAL y, bool rel=false);    // T, t
			void curve4(Gdiplus::REAL x1, Gdiplus::REAL y1,                   // C, c
				Gdiplus::REAL x2, Gdiplus::REAL y2, 
				Gdiplus::REAL x,  Gdiplus::REAL y, bool rel=false);
			void curve4(Gdiplus::REAL x2, Gdiplus::REAL y2,                   // S, s
				Gdiplus::REAL x,  Gdiplus::REAL y, bool rel=false);
			...
			void fill(const Gdiplus::Color& f);
			void stroke(const Gdiplus::Color& s);
			void even_odd(bool flag);
			void stroke_width(Gdiplus::REAL w);
			void fill_none();
			void stroke_none();
			void fill_opacity(Gdiplus::REAL op);
			void stroke_opacity(Gdiplus::REAL op);
			void line_join(Gdiplus::LineJoin join);
			void line_cap(Gdiplus::LineCap cap);
			void miter_limit(Gdiplus::REAL ml);
...
class CNavView : public CWindowImpl<CNavView>
{
public:
	DECLARE_WND_CLASS(NULL)

	IW::svg::path_renderer m_svg;

	CNavView()
	{
		IW::svg::parser parse(m_svg);
		parse.parse(_T("Navigator.svg"));
	}
